...
//	pRGBImage3 = auxDIBImageLoadA("TexImage00.bmp"); //왼쪽
...
//	pRGBImage3 = auxDIBImageLoadA("TexImage00.bmp"); //오른쪽
//	glTexImage2D(GL_TEXTURE_2D, 0, 3, pRGBImage3->sizeX, pRGBImage3->sizeY, 0, GL_RGB, GL_UNSIGNED_BYTE, pRGBImage3->data);
//	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);
//	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT);
//	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
...
//	pRGBImage3 = auxDIBImageLoadA("TexImage12.bmp");
//	glTexImage2D(GL_TEXTURE_2D, 0, 3, pRGBImage3->sizeX, pRGBImage3->sizeY, 0, GL_RGB, GL_UNSIGNED_BYTE, pRGBImage3->data);
//	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);
//	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT);
//	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
...
//	pRGBImage3 = auxDIBImageLoadA("TexImage56.bmp");
//	glTexImage2D(GL_TEXTURE_2D, 0, 3, pRGBImage3->sizeX, pRGBImage3->sizeY, 0, GL_RGB, GL_UNSIGNED_BYTE, pRGBImage3->data);
//	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);
//	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT);
//	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
...
//	pRGBImage3 = auxDIBImageLoadA("TexImage00.bmp"); //뒤
//	glTexImage2D(GL_TEXTURE_2D, 0, 3, pRGBImage3->sizeX, pRGBImage3->sizeY, 0, GL_RGB, GL_UNSIGNED_BYTE, pRGBImage3->data);
//	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);
//	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT);
//	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
...
//	pRGBImage3 = auxDIBImageLoadA("TexImage00.bmp"); //정면
//	glTexImage2D(GL_TEXTURE_2D, 0, 3, pRGBImage3->sizeX, pRGBImage3->sizeY, 0, GL_RGB, GL_UNSIGNED_BYTE, pRGBImage3->data);
//	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);
//	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT);
//	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
...
//	glTexCoord2f(10, 0);	glNormal3f(-1, 0, 0);	glVertex3f(-g_nSkySize, -g_nSkySize, -g_nSkySize);
//	glTexCoord2f(10, 10);	glNormal3f(-1, 0, 0);	glVertex3f(-g_nSkySize, -g_nSkySize, g_nSkySize);
//	glTexCoord2f(0, 10);	glNormal3f(-1, 0, 0);	glVertex3f(-g_nSkySize, g_nSkySize, g_nSkySize);
//	glEnd();
//
//	glBindTexture(GL_TEXTURE_2D, texMap[1]);
//	glBegin(GL_QUADS);
